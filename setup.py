...
setup(
    ...
    entry_points={
        "console_scripts": [
            ...
            "cmsContestWebServer=cms.server.contest:main",
            "cmsAdminWebServer=cms.server.admin:main",
            "cmsProxyService=cms.service.ProxyService:main",
            "cmsPrintingService=cms.service.PrintingService:main",
            "cmsRankingWebServer=cmsranking.RankingWebServer:main",
            "cmsInitDB=cmscontrib.InitDB:main",
            "cmsDropDB=cmscontrib.DropDB:main",
