...
from cms.testsuite import TestException, CONFIG
from cms.testsuite.Tests import ALL_TESTS
from cms.testsuite.coverage import clear_coverage, combine_coverage
