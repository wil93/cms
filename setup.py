...
setup(
    ...
    entry_points={
        "console_scripts": [
            "cmsRunFunctionalTests=cms.testsuite.RunFunctionalTests:main",
            "cmsAddAdmin=cms.contrib.AddAdmin:main",
            "cmsAddParticipation=cms.contrib.AddParticipation:main",
            "cmsAddStatement=cms.contrib.AddStatement:main",
            "cmsAddSubmission=cms.contrib.AddSubmission:main",
            "cmsAddTeam=cms.contrib.AddTeam:main",
            "cmsAddTestcases=cms.contrib.AddTestcases:main",
            "cmsAddUser=cms.contrib.AddUser:main",
            "cmsCleanFiles=cms.contrib.CleanFiles:main",
            "cmsDumpExporter=cms.contrib.DumpExporter:main",
            "cmsDumpImporter=cms.contrib.DumpImporter:main",
            "cmsDumpUpdater=cms.contrib.DumpUpdater:main",
            "cmsExportSubmissions=cms.contrib.ExportSubmissions:main",
            "cmsImportContest=cms.contrib.ImportContest:main",
            "cmsImportDataset=cms.contrib.ImportDataset:main",
            "cmsImportTask=cms.contrib.ImportTask:main",
            "cmsImportTeam=cms.contrib.ImportTeam:main",
            "cmsImportUser=cms.contrib.ImportUser:main",
            "cmsRWSHelper=cms.contrib.RWSHelper:main",
            "cmsRemoveContest=cms.contrib.RemoveContest:main",
            "cmsRemoveParticipation=cms.contrib.RemoveParticipation:main",
            "cmsRemoveSubmissions=cms.contrib.RemoveSubmissions:main",
            "cmsRemoveTask=cms.contrib.RemoveTask:main",
            "cmsRemoveUser=cms.contrib.RemoveUser:main",
            "cmsSpoolExporter=cms.contrib.SpoolExporter:main",
            "cmsMake=cms.taskenv.cmsMake:main",
            "cmsPrometheusExporter=cms.contrib.PrometheusExporter:main",
            "cmsTelegramBot=cms.contrib.TelegramBot:main",
        ],
